...
SEED_CODES = [
    ...
    ("PRGRS_PENDING", "생성 대기", "도큐먼트 생성 작업 대기 상태"),
    ("PRGRS_PROCESSING", "생성 중", "도큐먼트 생성 작업 진행 상태"),
    ("PRGRS_COMPLETED", "생성 완료", "도큐먼트 생성 완료 상태"),
    ("PRGRS_FAILED", "생성 실패", "도큐먼트 생성 실패 상태"),
    ("ROLE_MEMBER", "멤버", "프로젝트 담당 권한"),
